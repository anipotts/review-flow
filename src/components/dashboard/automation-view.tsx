      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <Card>
          <CardContent className="flex items-center gap-3">
            <div className={`p-2 rounded-lg ${acuityEnabled ? "bg-green-100" : "bg-red-100"}`}>
              <Zap className={`h-5 w-5 ${acuityEnabled ? "text-green-600" : "text-red-600"}`} />
            </div>
            <div>
              <p className="text-xs text-gray-500">Acuity Connection</p>
        ...
        <Card>
          <CardContent className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-gray-500">Auto-Send Clients</p>
              <p className="text-sm font-semibold">{autoSendClients.length} active</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-semibold">Every Friday 1 PM ET</p>
            </div>
          </CardContent>
        </Card>
      </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-100">
                ...
                <th className="text-left text-xs font-medium text-gray-500 px-6 py-3">Week</th>
                <th className="text-left text-xs font-medium text-gray-500 px-6 py-3">New</th>
                <th className="text-left text-xs font-medium text-gray-500 px-6 py-3">Sent</th>
            ...
            <tbody>
              {recentBatches.map((batch) => (
                <tr key={batch.id} className="border-b border-gray-50">
                  ...
                  <td className="px-6 py-3 text-sm text-gray-600">{batch.total_new}</td>
                  <td className="px-6 py-3 text-sm text-gray-600">{batch.total_sent}</td>
